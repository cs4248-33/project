...
# Adapted from https://github.com/huggingface/transformers/tree/main/examples/pytorch/translation
...
def main():
    ...
    # Metrics
    sacrebleu = evaluate.load("sacrebleu", cache_dir=model_args.cache_dir)
    # Find a Chinese adapted implementation for rogue-score instead
    # rouge_score = evaluate.load("rouge", cache_dir=model_args.cache_dir)
    ...
    def compute_metrics(eval_preds):
        ...
        result["example"] = f"{decoded_preds[0]} | {decoded_labels[0]}"
